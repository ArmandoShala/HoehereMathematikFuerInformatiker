...
# x1 bis x9: Zahl steht für diverse Variablen (x, m, v etc.) -> muss man im Kopf mappen oder als Symbole ergänzen!
# y0 bis y9: Zahl steht für die jeweilige Ableitung!
# z0 = Startwert
# z1 - z9: Substitutionsfunktionen, sodass Transitivität gewährleistet ist
