...
x = np.array([1900, 1910, 1920, 1930, 1940, 1950, 1960, 1970, 1980, 1990, 2000, 2010], dtype=np.float64)  # Stützpunkte (Knoten) xi
y = np.array([75.995, 91.972, 105.711, 123.203, 131.669, 150.697, 179.323, 203.212, 226.505, 249.633, 281.422, 308.745], dtype=np.float64)  # Stützpunkte (Knoten) yi
x_int = 1999  # Zu interpolierender Wert
